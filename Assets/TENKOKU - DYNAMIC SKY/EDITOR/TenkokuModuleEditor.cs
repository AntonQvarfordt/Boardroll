...
public class TenkokuModuleEditor : Editor {
	...
	public override void OnInspectorGUI() {
    	...
    	Texture logoTex = Resources.Load("textures/gui_tex_tenkokulogo_i") as Texture;
		Texture divTex = Resources.Load("textures/gui_tex_tenkokudiv_i") as Texture;
		Texture divRevTex = Resources.Load("textures/gui_tex_tenkokudivrev_i") as Texture;
